...
const Heading = styled.h2`
    ${(props) => {
        if (props.mb) {
            ...
            return `margin-bottom: ${props.theme.margin["0"]}`;
        }
    }};
    ...
    ${(props) => {
        if (props.mt) {
            ...
            return `margin-top: ${props.theme.margin["0"]}`;
        }
    }};

    ${(props) => {
        if (props.pd) {
            return `padding: ${props.theme.padding[props.pd]}`;
        } else {
            return `padding: ${props.theme.padding["0"]}`;
        }
    }};
